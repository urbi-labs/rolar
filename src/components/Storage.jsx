...
const Storage = ({ data, step, submit, onComboChange, onInputChange, onComboChangeID, getPerformance, handleToggle }) => {
  ...
  const section = [
    ...
    <Storage2 onComboChange={onComboChange} step={step} handleToggle={handleToggle} submit={submit} onComboChangeID={onComboChangeID} data={data} onInputChange={onInputChange} getPerformance={getPerformance} />,
  ];
